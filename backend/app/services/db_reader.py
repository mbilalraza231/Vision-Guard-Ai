...
class DatabaseReader:
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            by_severity_rows = await db.fetch_all("SELECT severity, COUNT(*) FROM events WHERE status != 'resolved' GROUP BY severity")
            ...
            false_positive_rate = (
                low_conf_count / total_events * 100) if total_events > 0 else 0.0
